...
| F | Denge, oynanış testi, performans, belgeler | ✅ Tamamlandı — 15 hata düzeltildi (13 Arena + 2 site; mobil +N/portre, dükkân orman yuvası, diyalogda duraklatma, sızan pencere, kilitli görev, yatay telefon ve dar pencere HUD’u …), test notları: [oyunlar/arena.md](oyunlar/arena.md#test-notları-faz-f) |
