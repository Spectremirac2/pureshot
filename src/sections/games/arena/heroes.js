...
export const HEROES = {
  ...
  balta: {
    ...
    base: { hp: 940, mana: 240, hpRegen: 4, manaRegen: 6.5, speed: 5.05, armor: 0.2, evasion: 0 },
    grow: { hp: 72, mana: 12, dmg: 0.052 },
  ...
  buz: {
    ...
    base: { hp: 630, mana: 440, hpRegen: 1.8, manaRegen: 11, speed: 4.95, armor: 0.08, evasion: 0 },
  ...
  golge: {
    ...
    base: { hp: 700, mana: 270, hpRegen: 2.8, manaRegen: 7.5, speed: 5.65, armor: 0.08, evasion: 0.2 },
    grow: { hp: 48, mana: 14, dmg: 0.05 },
