...
//
// Şema: id, name, icon, cost, tier, desc, stat (pasif katkılar; recalc'ta toplanır: hp, mana, dmg, dmgMul, speed,
//   evasion, atkSpeed, manaRegen, burn, aghs…), active: { cd, mana?, use(g, slot) → bool }, charges (tüketilebilir),
//   components: [] → ileride tarif (recipe) sistemi için ayrıldı (şimdilik boş; eşyalar doğrudan satın alınır).
