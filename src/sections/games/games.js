...
const ARENA = {
  ...
  color: 'var(--aegis)',
  kind: 'Ultimate · R',
  blurb: 'Altı kahraman, tarifli eşyalar, yetenek ağacı ve 15 görevlik hikâye: Dokuzun Laneti. Sonsuz modda DOG sürüleri, Dire creep’leri ve Roshan’a karşı tek başına: 1vDOQUZ.',
  time: 'Görev ~3 dk',
  diff: 3,
  unit: 'puan',
  higherIsBetter: true,
